...
public class RapportinoInviato {
	...
	public RapportinoInviato(Integer id, String nome, String cognome, String codiceFiscale, Integer anno, Integer mese,
			Boolean checkFreeze) {
		super();
		this.id = id;
		this.nome = nome;
